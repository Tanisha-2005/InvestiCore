...
import { Shield, Lock, User as UserIcon, Key, X, CheckCircle2, ArrowRight } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0b0f17] p-4 relative">
      ...
      {/* Google OAuth Interactive Modal */}
      {showGoogleModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#111827] border border-blue-500/40 rounded-2xl p-6 w-full max-w-sm space-y-5 shadow-2xl relative">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-gray-400">Choose your Google Account to sign in to InvestiCore</p>
            </div>
